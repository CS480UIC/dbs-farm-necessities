...
export const updateAddress =
  'UPDATE address SET user_id= ?,address= ? WHERE address_id = ?;';
...
export const updateProduct =
  'UPDATE product SET user_id= ?, name = ?, description = ?, price = ? WHERE product_id = ?;';
...
export const insertProductCategory =
  'INSERT INTO product_category (product_id,category_id) VALUES(?, ?);';
export const updateProductCategory =
  'UPDATE product_category SET product_id= ?, category_id = ? WHERE product_category_id = ?;';
...
export const updateCart =
  'UPDATE cart SET user_id= ?,product_id= ?, quantity = ? WHERE cart_id = ?;';
...
export const insertRating =
  'INSERT INTO rating (user_id,product_id,rating,review) VALUES(?, ?, ?,?);';
